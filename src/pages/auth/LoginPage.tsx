    ...
    <div className="min-h-screen flex items-center justify-center bg-[#A69FB8]">
      ...
      <div className="w-full max-w-[818px] bg-white rounded-lg shadow-[0px_4px_4px_0px_#00000040] px-6 py-10 sm:px-[50px] sm:py-[50px] flex flex-col gap-[15px] items-center">
        ...
        <a 
          ...
          className="w-full max-w-[508px] font-['CMU'] font-light italic text-base sm:text-[20px] text-[#64748B] text-right hover:text-[#5E4481] transition-colors duration-200"
        >
