              ...
              {isLoading ? (
                ...
                filteredTeachers.map((teacher, index) => (
                  ...
                  >
                    ...
                    <button
                      onClick={() => setConfirmTarget(teacher.cmuitaccount)}
      ...
      {confirmTarget && (
        <div className="fixed inset-0 flex justify-center items-center z-50" style={{ backgroundColor: '#3F3F3F80' }}>
          <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 max-w-[440px] w-full mx-4">
            <h3 className="text-lg font-bold text-gray-800 mb-2">Remove Teacher</h3>
            <p className="text-gray-600 mb-6">
              Are you sure you want to remove <span className="font-semibold text-gray-800">{confirmTarget}</span> from the teacher list?
            </p>
            <div className="flex justify-end gap-3">
              ...
              <button
                onClick={() => {
                  handleDeleteTeacher(confirmTarget);
